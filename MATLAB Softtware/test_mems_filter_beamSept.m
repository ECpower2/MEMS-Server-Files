function test_mems_filter_beamSept(filename)
...
%     x_post(4) = 1/sqrt(2); x_post(5) = 1/sqrt(2);     % ned = [1 0 0 0] mn
    ...
    gyro_n1 = [data(1,c0+23) -data(1,c0+21) -data(1,c0+22)]*pi/180;   % ned
...
%         qKin = [qKin(1) qKin(2) -qKin(4) qKin(3)];              % mn
        ...
        ESens = [ESensx ESensy ESensz];                         % ned
...
%         wKalman = [-x_post(2) -x_post(3) x_post(1)];             % mn
%         qKalman = q_prod(x_post(4:7),[1/sqrt(2) -1/sqrt(2) 0 0]); % mn
        wKalman = x_post(1:3)';                                % ned
        qKalman = x_post(4:7)';                                % ned
        ...
        % time update
        EKin_n1 = EKin;
%         EKin = [-EKin(2) -EKin(3) EKin(1)];                      % mn
        %     acc_n1 = acc;
        gyro_n1 = gyro;
%         gyro = [-gyro(2) -gyro(3) gyro(1)];                      % mn
