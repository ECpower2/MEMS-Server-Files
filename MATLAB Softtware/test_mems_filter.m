function test_mems_filter(filename)
...
[n,c] = size(data);
n_nodes = floor(c/25);  % n_nodes = floor((c-1)/24);
...
for j = 1:n_nodes
    ...
    % t = 0
    % acc_n1 = data(1,c0+14:c0+16) - accBias;
    % mag_n1 = data(1,c0+17:c0+19) - magBias;
    gyro_n1 = [data(1,c0+20) data(1,c0+22) -data(1,c0+21)]*pi/180;   % ned
    qG0 = data(1,c0:c0+3);                                           % mn
    qKin_n1 = [1 0 0 0];
    ...
    for i = 2:n
        %     display(['i = ',num2str(i)])
        time = data(i,1);
        acc = data(i,c0+14:c0+16) - accBias;                         % mn
        mag = data(i,c0+17:c0+19) - magBias;                         % mn
        gyro = [data(i,c0+20) data(i,c0+22) -data(i,c0+21)]*pi/180;  % ned
        qG = data(i,c0:c0+3);                                        % mn
